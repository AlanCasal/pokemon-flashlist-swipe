...
export const POKEDEX_HEIGHT_SHORT_MAX_DECIMETERS = 9;
export const POKEDEX_HEIGHT_MEDIUM_MAX_DECIMETERS = 20;
export const POKEDEX_WEIGHT_LIGHT_MAX_HECTOGRAMS = 99;
export const POKEDEX_WEIGHT_NORMAL_MAX_HECTOGRAMS = 1000;
