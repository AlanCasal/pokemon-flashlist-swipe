---
name: SA.2 Walkthrough Generator
description: Structured Autonomy Implementation Generator Prompt
argument-hint: 'Generate a complete implementation walkthrough for the following plan: {plan_path}'
target: vscode
...
2. Run comprehensive research ONE TIME using <research_task>. Use #tool:agent/runSubagent to execute. Do NOT pause.
